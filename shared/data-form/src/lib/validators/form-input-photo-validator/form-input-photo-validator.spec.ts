...
import { formInputPhotoValidatorRequired } from './form-input-photo-validator';
...
describe('shared:data-core:validators:form-input-photo', () => {
    let tests = [
        ...
        {value: {}, required: false, recognition: false, processed: false, valid: true},
        {value: {}, required: true, recognition: false, processed: false, valid: false},
        {value: {}, required: false, recognition: false, processed: true, valid: true},
        ...
        {value: {}, required: false, recognition: true, processed: true, valid: true},
        {value: {}, required: true, recognition: true, processed: true, valid: false},

        {value: undefined, required: false, recognition: false, processed: false, valid: true},
        {value: undefined, required: true, recognition: false, processed: false, valid: false},
        {value: undefined, required: false, recognition: false, processed: true, valid: true},
        ...
        {value: undefined, required: false, recognition: true, processed: true, valid: true},
    ...
    tests.forEach(t => {
        it(`${JSON.stringify(t.value)} and required ${t.required} and image recognition ${t.recognition} and processed ${t.processed} should ${t.valid ? '' : 'not '}be valid`, () => {
            ...
            expect(formInputPhotoValidatorRequired({
                required: t.required,
                isImageRecognition: t.recognition
            })(fc)).toEqual(t.valid ? null : {FormInputMultiphotosValidator: {valid: false}});
        });
    });
});