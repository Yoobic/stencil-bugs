...
class YooSlimScrollComponent {
    ...
    static get style() { return ":host(.dark) .scroll-slot-container {\n  border: 1px solid var(--dark, #444); }\n\n:host(.success) .scroll-slot-container {\n  border: 1px solid var(--success, #2EDBB7); }\n\n:host(.danger) .scroll-slot-container {\n  border: 1px solid var(--danger, #ff625f); }\n\n:host(.accent) .scroll-slot-container {\n  border: 1px solid var(--accent, #1FB6FF); }\n\n:host(.warning) .scroll-slot-container {\n  border: 1px solid var(--warning, #ff6402); }\n\n:host(.info) .scroll-slot-container {\n  border: 1px solid var(--info, #fc459e); }\n\n:host {\n  width: 100%;\n  height: 100%; }\n  :host .scroll-slot-container {\n    position: relative;\n    overflow: hidden; }\n    :host .scroll-slot-container .scroll-slot-content {\n      min-height: 100%; }\n\n:host(.horizontal) .scroll-slot-container {\n  white-space: nowrap; }\n\n:host /deep/ .scroll-zoom-wrapper {\n  width: 100%; }\n\n:host /deep/ .iScrollLoneScrollbar:hover {\n  opacity: 1 !important;\n  -webkit-transition: opacity .3s !important;\n  transition: opacity .3s !important; }\n\n:host /deep/ .iScrollHorizontalScrollbar {\n  position: absolute;\n  z-index: 100;\n  height: 8px;\n  left: 2px;\n  right: 2px;\n  bottom: 2px;\n  overflow: hidden; }\n\n:host /deep/ .iScrollHorizontalScrollbar.iScrollBothScrollbars {\n  right: 10px; }\n\n:host /deep/ .iScrollVerticalScrollbar {\n  position: absolute;\n  z-index: 100;\n  width: 8px;\n  bottom: 2px;\n  top: 2px;\n  right: 2px;\n  overflow: hidden; }\n\n:host /deep/ .iScrollVerticalScrollbar.iScrollBothScrollbars {\n  bottom: 10px; }\n\n:host /deep/ .iScrollIndicator {\n  position: absolute;\n  background: var(--dark, #444);\n  opacity: 0.3;\n  border-width: 1px;\n  border-style: solid;\n  border-color: var(--darker, );\n  border-radius: 3px; }\n\n:host /deep/ .iScrollHorizontalScrollbar .iScrollIndicator {\n  height: 100%; }\n\n:host /deep/ .iScrollVerticalScrollbar .iScrollIndicator {\n  width: 100%; }"; }
}
