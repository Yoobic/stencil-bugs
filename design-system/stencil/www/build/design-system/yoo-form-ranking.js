...
class YooFormRankingComponent {
    ...
    static get style() { return ":host .ranking-container {\n  border: 1px solid var(--dark-40, #b4b4b4);\n  border-bottom: 0px; }\n  :host .ranking-container .item-container {\n    border-bottom: 1px solid var(--dark-40, #b4b4b4);\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n    -ms-flex-align: center;\n    align-items: center;\n    padding: 0.3rem 0.5rem;\n    color: var(--dark, #444); }\n    :host .ranking-container .item-container .rank-indicator {\n      margin-right: 0.5rem;\n      border-radius: 50%;\n      background: var(--success, #2EDBB7);\n      color: var(--light, #FFFFFF);\n      height: 1.3rem;\n      width: 1.3rem;\n      text-align: center;\n      font-size: 0.9rem; }\n\n:host(.accent) .ranking-container .item-container .rank-indicator {\n  background: var(--accent, #1FB6FF); }\n\n:host(.danger) .ranking-container .item-container .rank-indicator {\n  background: var(--danger, #ff625f); }\n\n:host(.info) .ranking-container .item-container .rank-indicator {\n  background: var(--info, #fc459e); }\n\n:host(.dark) .ranking-container .item-container .rank-indicator {\n  background: var(--dark, #444); }\n\n:host(.success) .ranking-container .item-container .rank-indicator {\n  background: var(--success, #2EDBB7); }\n\n:host(.warning) .ranking-container .item-container .rank-indicator {\n  background: var(--warning, #ff6402); }\n\n:host(.gradient-accent) .ranking-container .item-container .rank-indicator {\n  background: var(--gradient-accent, linear-gradient(90deg, #1C76FC 0%, #D6E7FF 160.99%)); }\n\n:host(.gradient-danger) .ranking-container .item-container .rank-indicator {\n  background: var(--gradient-danger, linear-gradient(264deg, #ff625f, #c73634)); }\n\n:host(.gradient-info) .ranking-container .item-container .rank-indicator {\n  background: var(--gradient-info, linear-gradient(264deg, #fc459e, #9c2860)); }\n\n:host(.gradient-dark) .ranking-container .item-container .rank-indicator {\n  background: var(--gradient-dark, linear-gradient(90deg, #3A3569 0%, #4334A3 102.47%)); }\n\n:host(.gradient-warning) .ranking-container .item-container .rank-indicator {\n  background: var(--gradient-warning, linear-gradient(90deg, #F2C83A 0%, #FFE385 160.99%)); }\n\n:host(.gradient-success) .ranking-container .item-container .rank-indicator {\n  background: var(--gradient-success, linear-gradient(309deg, #15daba, #13deb4 20%, #0de8a2 49%, #04f884 82%, #00ff78)); }"; }
}
